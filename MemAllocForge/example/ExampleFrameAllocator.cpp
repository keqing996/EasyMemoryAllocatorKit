...
void DemonstrateBasicFrameSwapping()
{
    ...
    MAF::FrameAllocator<2> allocator(1024);
...
void DemonstrateMultipleBuffers()
{
    ...
    MAF::FrameAllocator<3> allocator(512);
...
void DemonstrateGameFramePattern()
{
    ...
    MAF::FrameAllocator<2> allocator(2048);
...
void DemonstrateSTLWithFrameAllocator()
{
    ...
    MAF::FrameAllocator<2> allocator(4096);
    
    // Define STL allocator adapter for frame allocator
    using IntVectorAllocator = MAF::STLAllocatorAdapter<int, MAF::FrameAllocator<2>>;
...
void DemonstratePerformanceComparison()
{
    ...
    MAF::FrameAllocator<2> allocator(8192);
...
void DemonstrateResetAllFrames()
{
    ...
    MAF::FrameAllocator<3> allocator(1024);

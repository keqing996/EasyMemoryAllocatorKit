...
int main()
{
    ...
    MAF::FreeListAllocator connectionAllocator(16 * 1024 * 1024);
    ...
    using ConnectionVectorAllocator = MAF::STLAllocatorAdapter<Connection*, MAF::FreeListAllocator>;
    ...
    using StringVectorAllocator = MAF::STLAllocatorAdapter<std::string, MAF::FreeListAllocator>;
    ...
    using IntAllocator = MAF::STLAllocatorAdapter<int, MAF::FreeListAllocator>;

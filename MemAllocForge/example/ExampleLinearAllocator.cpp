...
int main()
{
    ...
    MAF::LinearAllocator frameAllocator(8 * 1024 * 1024);
    ...
    using FloatVectorAllocator = MAF::STLAllocatorAdapter<float, MAF::LinearAllocator>;
    using IntVectorAllocator = MAF::STLAllocatorAdapter<int, MAF::LinearAllocator>;
    using Vec3VectorAllocator = MAF::STLAllocatorAdapter<float[3], MAF::LinearAllocator>;

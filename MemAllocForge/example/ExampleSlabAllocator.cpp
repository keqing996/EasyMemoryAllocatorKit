...
int main()
{
    ...
    MAF::SlabAllocator mouseEventPool(sizeof(MouseEvent), 32);
    MAF::SlabAllocator keyEventPool(sizeof(KeyboardEvent), 32);
    MAF::SlabAllocator netEventPool(sizeof(NetworkEvent), 16);
